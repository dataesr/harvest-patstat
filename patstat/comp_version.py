...
def get_json(patent, fam, fam_techno, part, role):
    patent = patent["appln_auth", "appln_publn_number", "internat_appln_id", "publn_kind", "key_appln_nr",
                    "docdb_family_id", "ispriority", "ipr_type", "appln_filing_date", "appln_publn_date",
                    "grant_publn_date", "appln_nr"]].copy()
