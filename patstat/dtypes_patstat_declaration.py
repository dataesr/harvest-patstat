...
oa_types = {"key_appln_nr": object,
            "appln_id": pd.Int64Dtype(),
            "docdb_family_id": pd.Int64Dtype(),
            "pat_publn_id": pd.Int64Dtype(),
            "doi_clean": str,
            "doi": str,
            "id": str,
            "display_name": str,
            "orcid": str,
            "display_name_title": str,
            "title": str,
            "id_pub": str,
            "language": str,
            "type": str,
...
tls231_types = {"event_id": int,
          "appln_id": pd.Int64Dtype(),
          "event_seq_nr": int,
          "event_type": str,
          "event_auth": str,
          "event_code": str,
          "event_filing_date": object,
          "event_publn_date": object,
          ...
          "party_old": str,
          "spc_nr": str,
          "spc_filing_date": object,
          "spc_patent_expiry_date": object,
          "spc_extension_date": object,
          "spc_text": str,
          "designated_states": str,
          "extension_states": str,
          "fee_country": str,
          "fee_payment_date": object,
          "fee_renewal_year": object,
          "fee_text": str,
          "lapse_country": str,
          "lapse_date": object,
          "lapse_text": str,
          "reinstate_country": str,
          "reinstate_date": object,
          "reinstate_text": str,
          "class_scheme": str,
          "class_symbol": str}
